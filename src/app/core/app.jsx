...
import TopNav from '../themes/youcanparts/components/topnav/topnav';
import Loader from '../themes/youcanparts/components/loader/loader';
import Chat from '../themes/youcanparts/components/chat/chat';
import Calendar from '../themes/youcanparts/components/calendar/calendar';
import Grades from '../themes/youcanparts/components/grades/grades';
import Help from '../themes/youcanparts/components/help/help';
import Footer from '../themes/youcanparts/components/footer/footer';
import Notification from '../themes/youcanparts/components/notification/notification';
...
class App extends Component {
  ...
  render() {
    ...
    if (!this.props.breadcrumbs[0]) {
      ...
      title = `${this.props.breadcrumbs.reverse().join(' < ')} < You Can`;
    }
